...
function CommandInput({
  ...
  return (
    <div data-slot='command-input-wrapper' className='px-4 py-2'>
      <InputGroup className='h-8! rounded-none! border-0 border-b border-border bg-transparent shadow-none! *:data-[slot=input-group-addon]:pl-2!'>
...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        'no-scrollbar max-h-[420px] scroll-py-1 overflow-x-hidden overflow-y-auto outline-none',
        className,
      )}
      {...props}
    />
